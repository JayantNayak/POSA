...
public class LoginActivity extends StoryActivityBase{
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48
				...
				StorageUtilities.SECURITY_PRIVATE,//here the passed value is defined in StorageUtilities.java
				//so that if we fix patches in StorageUtilities.java it won't affect LoginActivity.java
				null);//made it to null so that files are generated according to unique timestamp names 
					//which is defined in line 106 StorageUtilities.java
